...
class CreatePostTool extends Tool
{
    ...
    public function handle(Request $request): Response|ResponseFactory
    {
        ...
        $availableAccountIds = $workspace->socialAccounts()->active()->pluck('id')->all();
        ...
        return [
            ...
            'platforms' => $schema->array()
                ->items($schema->object(fn ($p) => [
                    ...
                    'content_type' => $p->string()->required()->description('Format for this platform (e.g. linkedin_page_post, x_post, instagram_feed).'),
